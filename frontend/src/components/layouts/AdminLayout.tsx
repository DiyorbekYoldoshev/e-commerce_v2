...
import {
  ...
  FolderTree, Store, FileText, LogOut, ChevronRight,
  Menu, X,
} from "lucide-react";
...
const navItems = [
  ...
  { label: "Buyurtmalar", icon: ShoppingCart, path: "/admin/orders" },
  { label: "Mahsulotlar", icon: Package, path: "/admin/products" },
  { label: "Kategoriyalar", icon: FolderTree, path: "/admin/categories" },
  { label: "Sellerlar", icon: Store, path: "/admin/sellers" },
  { label: "Seller arizalar", icon: FileText, path: "/admin/seller-requests" },
];
